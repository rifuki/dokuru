...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* radial accent */}
      <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[900px] h-[500px] rounded-full bg-[#2496ED]/10 blur-[140px] pointer-events-none" />
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <span className="relative inline-block">
                ...
                <span className="absolute -bottom-2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#2496ED]/50 to-transparent" />
              </span>
            </h1>
            ...
            <ul className="mt-10 grid sm:grid-cols-1 gap-3 max-w-xl">
              <Support>Agent-based Docker host inspection</Support>
              <Support>Namespace and cgroup-focused security checks</Support>
              <Support>One-click fixes for supported misconfigurations</Support>
            </ul>
          </div>
