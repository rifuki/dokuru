...
pub(crate) fn hero() -> impl IntoView {
    view! {
        <section id="top" data-testid="hero-section" class="relative min-h-[95svh] flex flex-col justify-center overflow-hidden px-0 pt-20 pb-16 md:pt-24 md:pb-24">
            ...
            <div class="relative mx-auto w-full max-w-7xl px-6 md:px-10">
                <div class="flex flex-col items-center text-center">
                    <h1 data-testid="hero-headline" class="animate-enter-up max-w-[800px] font-heading text-5xl font-bold tracking-tight leading-[1.1] text-white sm:text-6xl lg:text-[72px]" style="--motion-delay: 300ms; --motion-duration: 800ms">
                    ...
                    <p data-testid="hero-subheadline" class="animate-enter-up mt-6 max-w-2xl text-[16px] leading-relaxed text-zinc-400 md:text-[18px]" style="--motion-delay: 500ms; --motion-duration: 600ms">
                    ...
                    <div class="animate-enter-up mt-8 flex flex-wrap items-center justify-center gap-3" style="--motion-delay: 700ms; --motion-duration: 600ms">
                    ...
                    <div class="animate-enter-up mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm font-medium text-zinc-500" style="--motion-delay: 800ms; --motion-duration: 600ms">
                    ...
                    <div class="animate-enter-up relative mt-16 w-full max-w-[640px]" style="--motion-delay: 900ms">
                        <div class="absolute inset-0 scale-90 rounded-full bg-[#2496ED]/10 blur-[100px]"/>
                        <div class="relative overflow-hidden rounded-2xl border border-white/10 bg-[#050505] shadow-[0_0_54px_rgba(0,0,0,0.78)] text-left">
                            {audit_panel()}
                        </div>
                    </div>
                </div>
