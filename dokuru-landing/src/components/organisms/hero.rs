            ...
            <div class="relative mx-auto w-full max-w-7xl px-6 md:px-10">
                <div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-20">
                    <div class="min-w-0">
                        ...
                        <p data-testid="hero-subheadline" class="animate-enter-up mt-6 max-w-xl text-[16px] leading-relaxed text-zinc-400 md:text-[18px]" style="--motion-delay: 500ms; --motion-duration: 600ms">
