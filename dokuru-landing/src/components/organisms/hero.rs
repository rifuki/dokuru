        ...
        <section id="top" data-testid="hero-section" class="relative min-h-[92svh] flex flex-col justify-center overflow-hidden px-0 pt-20 pb-16 md:pt-24 md:pb-24">
            ...
            <div class="relative mx-auto w-full max-w-7xl px-6 md:px-10">
                <div class="flex flex-col items-center text-center">
                    ...
                    <p data-testid="hero-subheadline" class="animate-enter-up mt-6 max-w-[640px] text-[16px] leading-relaxed text-zinc-400 md:text-[18px]" style="--motion-delay: 500ms; --motion-duration: 600ms">
                    ...
                    <div class="animate-enter-up relative mt-16 w-full max-w-[800px]" style="--motion-delay: 900ms">
