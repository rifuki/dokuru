...
pub(crate) fn terminal_install_panel(
    ...
    view! {
        <>
            <div class="flex min-w-0 items-center px-4 py-3 border-b border-white/10 bg-[#0d0d0f]">
                ...
                <span class="ml-3 min-w-0 truncate font-mono text-[11px] text-zinc-500">"bash · docker-host-01"</span>
                <button on:click=handle_copy class="ml-auto inline-flex shrink-0 cursor-pointer items-center gap-1.5 rounded border border-white/10 px-2 py-1 font-mono text-[10px] uppercase tracking-[0.18em] text-zinc-400 transition-colors hover:border-white/25 hover:text-white">
            ...
            <div class="min-w-0 space-y-3 p-4 font-mono text-[11px] leading-6 sm:p-6 sm:text-[13px] sm:leading-7">
                <div class="flex items-start gap-3">
                    <span class="text-[#2496ED]">"$"</span>
                    <div class="min-w-0 flex-1 break-all"><span class="text-zinc-100">"curl -fsSL "</span><span class="text-[#00E5FF]">"https://dokuru.rifuki.dev/install"</span><span class="text-zinc-100">" | bash"</span></div>
                </div>
...
pub(crate) fn cloud_dashboard_panel() -> impl IntoView {
    view! {
        <>
            <div class="flex min-w-0 items-center px-4 py-3 border-b border-white/10 bg-[#0d0d0f]">
                <div class="flex gap-1.5"><span class="w-2.5 h-2.5 rounded-full bg-zinc-700"/><span class="w-2.5 h-2.5 rounded-full bg-zinc-700"/><span class="w-2.5 h-2.5 rounded-full bg-zinc-700"/></div>
                <span class="ml-3 min-w-0 truncate font-mono text-[11px] text-zinc-500">"app.dokuru.rifuki.dev"</span>
            </div>
...
pub(crate) fn agent_dashboard_panel() -> impl IntoView {
    view! {
        <>
            <div class="flex min-w-0 items-center px-4 py-3 border-b border-white/10 bg-[#0d0d0f]">
                <div class="flex gap-1.5"><span class="w-2.5 h-2.5 rounded-full bg-zinc-700"/><span class="w-2.5 h-2.5 rounded-full bg-zinc-700"/><span class="w-2.5 h-2.5 rounded-full bg-zinc-700"/></div>
                <span class="ml-3 min-w-0 truncate font-mono text-[11px] text-zinc-500">"dokuru-agent · local dashboard"</span>
            </div>
            <div class="min-w-0 space-y-3 p-4 font-mono text-[11px] leading-6 sm:text-[12px] sm:leading-7 md:p-6">
                <div class="text-zinc-500 text-[11px]">"# Direct agent dashboard:"</div>
                <div class="space-y-1.5 pl-2 border-l-2 border-[#2496ED]/30">
                    <div class="break-all text-zinc-300">"Host:  " <span class="text-[#00E5FF]">"http://x.x.x.x:3939"</span></div>
                    <div class="break-all text-zinc-300">"Local: " <span class="text-[#00E5FF]">"http://localhost:3939"</span></div>
                    <div class="break-all text-zinc-300">"Token: " <span class="text-amber-300">"dok_cbb8becb44ca7ace..."</span></div>
                </div>
                <div class="mt-4 pt-4 border-t border-white/5 space-y-2">
                    <div class="flex items-start gap-3">
                        <span class="text-[#2496ED]">"$"</span>
                        <span class="min-w-0 break-all text-zinc-100">"ssh -L 3939:localhost:3939 " <span class="text-[#00E5FF]">"user@docker-host-01"</span></span>
                    </div>
                    <div class="flex items-start gap-3">
                        <span class="text-[#2496ED]">"$"</span>
                        <span class="min-w-0 break-all text-zinc-100">"open " <span class="text-[#00E5FF]">"http://localhost:3939"</span></span>
                    </div>
                </div>
...
pub(crate) fn audit_preview_panel() -> impl IntoView {
    view! {
        <>
            <div class="flex min-w-0 items-center px-4 py-3 border-b border-white/10 bg-[#121214]">
                <div class="flex gap-1.5"><span class="w-2.5 h-2.5 rounded-full bg-zinc-700"/><span class="w-2.5 h-2.5 rounded-full bg-zinc-700"/><span class="w-2.5 h-2.5 rounded-full bg-zinc-700"/></div>
                <span class="ml-3 min-w-0 truncate font-mono text-[11px] text-zinc-500">"dokuru-agent " <span class="text-zinc-700">"~"</span> " " <span class="text-zinc-400">"target:"</span> " " <span class="text-[#2496ED]">"prod-cluster-01"</span></span>
                <span class="ml-auto inline-flex shrink-0 items-center gap-1.5 font-mono text-[10px] uppercase tracking-[0.18em] text-emerald-400"><span class="w-1.5 h-1.5 rounded-full bg-emerald-400 pulse-dot"/>"live"</span>
            </div>
            <div class="space-y-5 p-4 sm:p-6">
                <div class="flex flex-col gap-4 border-b border-white/5 pb-5 sm:flex-row sm:items-end sm:justify-between">
                    ...
                    <div class="flex gap-3 text-left sm:flex-col sm:items-end sm:gap-1.5 sm:text-right">
                ...
                <div class="flex flex-col gap-2 border-t border-white/5 pt-4 sm:flex-row sm:items-center sm:justify-between">
