...
pub const CONFIG_FIELD_SPECS: &[ConfigFieldSpec] = &[
    ConfigFieldSpec {
        ...
        env_keys: &["BOOTSTRAP_ENABLED", "DOKURU__BOOTSTRAP__ENABLED"],
    },
    ConfigFieldSpec {
        key: "bootstrap.admin_email",
        path: &["bootstrap", "admin_email"],
        env_keys: &["BOOTSTRAP_ADMIN_EMAIL", "DOKURU__BOOTSTRAP__ADMIN_EMAIL"],
    },
    ConfigFieldSpec {
    ...
    ConfigFieldSpec {
        ...
        env_keys: &["BOOTSTRAP_ADMIN_NAME", "DOKURU__BOOTSTRAP__ADMIN_NAME"],
    },
    ConfigFieldSpec {
        key: "server.port",
        path: &["server", "port"],
    ...
    ConfigFieldSpec {
        key: "app.rust_log",
        path: &["app", "rust_log"],
        env_keys: &["RUST_LOG", "DOKURU__APP__RUST_LOG"],
    },
    ConfigFieldSpec {
        key: "cookie.same_site",
        path: &["cookie", "same_site"],
        env_keys: &["COOKIE_SAME_SITE", "DOKURU__COOKIE__SAME_SITE"],
    },
    ConfigFieldSpec {
        key: "cookie.secure",
        path: &["cookie", "secure"],
        env_keys: &["COOKIE_SECURE", "DOKURU__COOKIE__SECURE"],
    },
    ConfigFieldSpec {
        key: "cookie.http_only",
        path: &["cookie", "http_only"],
        env_keys: &["COOKIE_HTTP_ONLY", "DOKURU__COOKIE__HTTP_ONLY"],
    },
    ConfigFieldSpec {
        key: "upload.dir",
        path: &["upload", "dir"],
        env_keys: &["UPLOAD_DIR", "DOKURU__UPLOAD__DIR"],
    },
    ConfigFieldSpec {
        key: "upload.base_url",
        path: &["upload", "base_url"],
        env_keys: &["UPLOAD_BASE_URL", "DOKURU__UPLOAD__BASE_URL"],
    },
    ConfigFieldSpec {
        key: "email.from_email",
        path: &["email", "from_email"],
        env_keys: &["EMAIL_FROM_EMAIL", "DOKURU__EMAIL__FROM_EMAIL"],
    },
    ConfigFieldSpec {
        key: "email.resend_api_key",
        path: &["email", "resend_api_key"],
        env_keys: &["RESEND_API_KEY", "DOKURU__EMAIL__RESEND_API_KEY"],
    },
    ConfigFieldSpec {
        key: "database.url",
        path: &["database", "url"],
        env_keys: &["DATABASE_URL", "DOKURU__DATABASE__URL"],
    },
    ConfigFieldSpec {
    ...
    ConfigFieldSpec {
        key: "redis.url",
        path: &["redis", "url"],
        env_keys: &["REDIS_URL", "DOKURU__REDIS__URL"],
    },
    ConfigFieldSpec {
        key: "auth.access_secret",
        path: &["auth", "access_secret"],
        env_keys: &["ACCESS_SECRET", "DOKURU__AUTH__ACCESS_SECRET"],
    },
    ConfigFieldSpec {
        key: "auth.refresh_secret",
        path: &["auth", "refresh_secret"],
        env_keys: &["REFRESH_SECRET", "DOKURU__AUTH__REFRESH_SECRET"],
    },
    ConfigFieldSpec {
        key: "auth.access_expiry_secs",
        path: &["auth", "access_expiry_secs"],
        env_keys: &["ACCESS_EXPIRY_SECS", "DOKURU__AUTH__ACCESS_EXPIRY_SECS"],
    },
    ConfigFieldSpec {
        key: "auth.refresh_expiry_secs",
        path: &["auth", "refresh_expiry_secs"],
        env_keys: &["REFRESH_EXPIRY_SECS", "DOKURU__AUTH__REFRESH_EXPIRY_SECS"],
    },
];
